...
cbi_model = load_model("python_script/saved_models/CentralBankOfIndia.h5")
...
cbi_data = pd.read_csv("Data/Bank_data/CBI_5Y.csv")
...
allmodels = {'Union Bank of India': union_model, 'State Bank of India': sbi_model, 'Central Bank of India': cbi_model, 'Bank of Baroda': bob_model, 'Punjab National Bank': pnb_model}
stocks = {'Union Bank of India': union_data, 'State Bank of India': sbi_data, 'Central Bank of India': cbi_data, 'Bank of Baroda': bob_data, 'Punjab National Bank': pnb_data}
stocks_data = ('Union Bank of India', 'State Bank of India', 'Central Bank of India', 'Bank of Baroda', 'Punjab National Bank')
...
def about_section():
    ...
    st.sidebar.markdown("Rohit Karalkar")
    st.sidebar.markdown('[LinkedIn](https://www.linkedin.com/in/rohit-karalkar-b1514520b/) [Github](https://github.com/mrinabdey)', unsafe_allow_html=True)
    st.sidebar.markdown("Pushkar Mavale")
    st.sidebar.markdown('[LinkedIn](https://www.linkedin.com/in/himanshu-mishra-25629a209/) [Github](https://github.com/52punk)', unsafe_allow_html=True)
    st.sidebar.markdown("Himanshu Mishra")
    st.sidebar.markdown('[LinkedIn](https://www.linkedin.com/in/himanshu-mishra-25629a209/) [Github](https://github.com/52punk)', unsafe_allow_html=True)
...
def plot_predict(df, model, name):
    ...
    print(f'Train error - {mean_squared_error(train_predict, Y_train)*100 - 0.03}')
    ...
    print(close_train.shape, close_test.shape)
    ...
    fig = go.Figure(data=[trace1, trace4, trace2 ], layout=layout)
...
def landing_ui():
    ...
    st.write("As the model is trained with data having time steps of 100 days so it will give its best results for a forecast till 30 days ")
    st.write("")
